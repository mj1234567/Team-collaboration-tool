    ...
    <td bgcolor="#eee" align="center" valign="top">
        ...
        <table border="0" width="200px" cellspacing="0" class="tableback shadow" id="showprojects" >
            ...
            <tr class="fonts">
                ...
                <td width="20%" align="left"><a href="chat_1.jsp?employee_id=<%=employee_id%>&&from_id=<%=from_id%>" class="button"> Start Chat</a> </td> 
                <% } %>
            </tr>
            <%
               f=name;  }
