...
public final class addclient1_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String s=(String)session.getAttribute("username");
      ...
      out.write("        ");
        ...
        boolean b=x.searchclient();
        if(b)
{ 
      out.write("   <span style=\"font-size: 24px; font-family: cursive\">   member already exist</span>\n");
      out.write("       ");
 } else
        {
       int a= x.saveclient();
